...
import { z } from 'zod'
import { SOCIAL_PLATFORMS, BUTTON_VARIANTS, BUTTON_SIZES } from '@clinro/types/schema'
...
export const tenantSchema = z.object({
  ...
  isActive: z
    .boolean()
    .optional(),
  themeId: z.enum(['editorial-brutalist', 'retro-terminal', 'soft-luxury', 'vaporwave', 'swiss-minimalist', 'dark-cyberpunk']).optional(),
})
